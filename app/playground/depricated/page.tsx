...
import { CartoonModel } from "./depricated-components/CartoonMonk";
import OptionSquare from "./depricated-components/OptionSquare";
import { Briefcase } from "./depricated-components/Briefcase";
import { Notebook } from "./depricated-components/Notebook";

export default function Home() {
    return (
        <div className="h-screen">
            <Canvas className="h-full w-full bg-cyan-200">
                <Scene />
            </Canvas>
        </div>
    );
...
function Scene() {
    ...
    return (
        <>
            ...
            s
            <CartoonModel />
            <Text font={"courier-prime.ttf"}>React</Text>
            <mesh position={[0, -2, 0]}>
